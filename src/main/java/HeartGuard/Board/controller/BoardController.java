...
//        }
//        boolean result = boardService.postBoard(userDto, loginUno);
...
//    //2.카테고리별 게시물 전체조회
//    @GetMapping("/all")
//    public ResponseEntity<List<BoardDto>>allProducts(
//            @RequestParam(required = false)long cno){
//        List<BoardDto> boardDtoList = boardService.allProducts( bno );
...
//            @RequestParam(required = false) Long bno,
//            @RequestParam(defaultValue = "1")int page,
//            @RequestParam(defaultValue = "5")int size,
//            @RequestParam(required = false)String keyword){
//        Page<BoardDto> boardDtoList = boardService.allBoards(bno,page,size,keyword);
//        return ResponseEntity.status(200).body(boardDtoList);
//    }
